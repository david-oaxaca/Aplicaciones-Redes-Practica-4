    ...
    class Manejador extends Thread {
        ...
        public void run() {
            try {
                ...
                br = new BufferedReader(new InputStreamReader(socket.getInputStream()/*, "windows-1252"*/));
                ...
                if (!line.contains("?")) {
                    if (line.toUpperCase().startsWith("POST")) {
                        ...
                        for(i= 2; i < tokens.length-1; i++) {
                            escritor.write(tokens[i] + "\r\n\r\n");
                        }
                        escritor.write(contenido_archivo);
                        escritor.close();
